...
inputFile1 = "file:/eos/user/y/yumeng/CMSSW_14_0_9/GEMCode/out_pr_pu200_1409.root"
inputFile2 = "file:/eos/user/y/yumeng/CMSSW_14_0_9/GEMCode/out_pr_pu200_1409pretrig5.root"
inputFile3 = "file:/eos/user/y/yumeng/CMSSW_14_2_0_pre1/GEMCode/out_pr_pu200_1420pre1pretrig224.root"
inputFile4 = "file:/eos/user/y/yumeng/CMSSW_14_2_0_pre1/GEMCode/out_pr_pu200_1420pre1.root"
baseDir = "/eos/user/y/yumeng/CMSSW_14_2_0_pre1/GEMCode/plot_pr4files_test/"
...
#change:
# Plotters for the 2nd file
plotter2_run3 = GEMCSCStubPlotter(inputFile2, baseDir, text, "GEMCSCAnalyzerRun3CCLUTILT")
plotter2_run3.setLegend("cmssw_1409_prerig5")

plotter2_run3layers = GEMCSCStubPlotter(inputFile2, baseDir, text, "GEMCSCAnalyzerRun3CCLUTILTclct3layers")
plotter2_run3layers.setLegend("cmssw_1409_prerig5")

# Plotters for the 3rd file
plotter3_run3 = GEMCSCStubPlotter(inputFile3, baseDir, text, "GEMCSCAnalyzerRun3CCLUTILT")
plotter3_run3.setLegend("cmssw_1420pre1_prerig224")

plotter3_run3layers = GEMCSCStubPlotter(inputFile3, baseDir, text, "GEMCSCAnalyzerRun3CCLUTILTclct3layers")
plotter3_run3layers.setLegend("cmssw_1420pre1_prerig224")

# Plotters for the 4th file
plotter4_run3 = GEMCSCStubPlotter(inputFile4, baseDir, text, "GEMCSCAnalyzerRun3CCLUTILT")
plotter4_run3.setLegend("cmssw_1420pre1")

plotter4_run3layers = GEMCSCStubPlotter(inputFile4, baseDir, text, "GEMCSCAnalyzerRun3CCLUTILTclct3layers")
plotter4_run3layers.setLegend("cmssw_1420pre1")

#Compare each tree across the two files using makeEfficiencyComparisonPlots
plotterlist_run3 = [plotter1_run3, plotter2_run3, plotter3_run3, plotter4_run3]
makeEfficiencyComparisonPlots(plotterlist_run3, text + " ")
#makeResolutionComparisonPlots (plotter1_run3, plotter4_run3)
makeComparePlots (plotterlist_run3, text + " ")

plotterlist_run3layers = [plotter1_run3layers, plotter2_run3layers, plotter3_run3layers, plotter4_run3layers]
makeEfficiencyComparisonPlots(plotterlist_run3layers, text + "clctNHitPattern=3")
# makeResolutionComparisonPlots (plotter1_run3, plotter4_run3)
