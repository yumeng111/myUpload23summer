...
fileName = cms.string("out_shower.root")
)
...
process.simCscTriggerPrimitiveDigisRun3CCLUTILTshow21=process.simCscTriggerPrimitiveDigisRun3CCLUTILT.clone()
process.simCscTriggerPrimitiveDigisRun3CCLUTILTshow21.clctPhase2.clctLocalShowerZone = 21
print("clctLocalShowerZone = 21 ", process.simCscTriggerPrimitiveDigisRun3CCLUTILTshow21.clctPhase2)
process.simEmtfDigisRun3CCLUTILTshow21 = process.simEmtfDigis.clone()
process.simEmtfDigisRun3CCLUTILTshow21.CSCInput = cms.InputTag(
    'simCscTriggerPrimitiveDigisRun3CCLUTILTshow21','MPCSORTED',process._Process__name)

process.simCscTriggerPrimitiveDigisRun3CCLUTILTshow19=process.simCscTriggerPrimitiveDigisRun3CCLUTILT.clone()
process.simCscTriggerPrimitiveDigisRun3CCLUTILTshow19.clctPhase2.clctLocalShowerZone = 19
print("clctLocalShowerZone = 19 ", process.simCscTriggerPrimitiveDigisRun3CCLUTILTshow19.clctPhase2)
process.simEmtfDigisRun3CCLUTILTshow19 = process.simEmtfDigis.clone()
process.simEmtfDigisRun3CCLUTILTshow19.CSCInput = cms.InputTag(
    'simCscTriggerPrimitiveDigisRun3CCLUTILTshow19','MPCSORTED',process._Process__name)
...
process.GEMCSCAnalyzerRun3CCLUTILTshow21 = process.GEMCSCAnalyzer.clone()
process.GEMCSCAnalyzerRun3CCLUTILTshow21.cscALCT.inputTag = cms.InputTag("simCscTriggerPrimitiveDigisRun3CCLUTILTshow21","",processName)
process.GEMCSCAnalyzerRun3CCLUTILTshow21.cscCLCT.inputTag = cms.InputTag("simCscTriggerPrimitiveDigisRun3CCLUTILTshow21","",processName)
process.GEMCSCAnalyzerRun3CCLUTILTshow21.cscLCT.inputTag = cms.InputTag("simCscTriggerPrimitiveDigisRun3CCLUTILTshow21","",processName)
process.GEMCSCAnalyzerRun3CCLUTILTshow21.cscMPLCT.inputTag = cms.InputTag("simCscTriggerPrimitiveDigisRun3CCLUTILTshow21","MPCSORTED",processName)
process.GEMCSCAnalyzerRun3CCLUTILTshow21.emtfTrack.inputTag = cms.InputTag("simEmtfDigisRun3CCLUTILTshow21","",processName)

process.GEMCSCAnalyzerRun3CCLUTILTshow19 = process.GEMCSCAnalyzer.clone()
process.GEMCSCAnalyzerRun3CCLUTILTshow19.cscALCT.inputTag = cms.InputTag("simCscTriggerPrimitiveDigisRun3CCLUTILTshow19","",processName)
process.GEMCSCAnalyzerRun3CCLUTILTshow19.cscCLCT.inputTag = cms.InputTag("simCscTriggerPrimitiveDigisRun3CCLUTILTshow19","",processName)
process.GEMCSCAnalyzerRun3CCLUTILTshow19.cscLCT.inputTag = cms.InputTag("simCscTriggerPrimitiveDigisRun3CCLUTILTshow19","",processName)
process.GEMCSCAnalyzerRun3CCLUTILTshow19.cscMPLCT.inputTag = cms.InputTag("simCscTriggerPrimitiveDigisRun3CCLUTILTshow19","MPCSORTED",processName)
process.GEMCSCAnalyzerRun3CCLUTILTshow19.emtfTrack.inputTag = cms.InputTag("simEmtfDigisRun3CCLUTILTshow19","",processName)
...
process.Analysis = cms.Sequence(
    ...
    process.GEMCSCAnalyzerRun3CCLUTILTshow21 *
    process.GEMCSCAnalyzerRun3CCLUTILTshow19
	)
...
process.debug = cms.Sequence(
    ...
    process.simMuonGEMPadDigiClusters *
    process.simCscTriggerPrimitiveDigisRun3CCLUTILT *
    process.simCscTriggerPrimitiveDigisRun3CCLUTILTshow21 *
    process.simCscTriggerPrimitiveDigisRun3CCLUTILTshow19 *
    process.simEmtfDigisRun3CCLUTILT *
    process.simEmtfDigisRun3CCLUTILTshow21 *
    process.simEmtfDigisRun3CCLUTILTshow19
        )
