...
// SLC5 - create target folder for ROOT package 'mkdir $HOME/rpm/BUILD/emu-ROOT'
// SLC5 - create symlink to instaled ROOT path  'ln -s /opt $HOME/rpm/BUILD/emu-ROOT/opt'
// SLC5 - edit root.spec file and adjust various version parameters for target package and also set correct path to installed ROOT binaries in %files section
