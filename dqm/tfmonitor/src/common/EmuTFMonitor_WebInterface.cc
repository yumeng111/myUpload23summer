...
// == XGI Call back == //
void EmuTFMonitor::Default(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
  showStatus(in,out);
  // wsm_.displayPage(out);
}

void EmuTFMonitor::showControl(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
  wsm_.displayPage(out);
}
// == WSM Dispatcher function == //
void EmuTFMonitor::dispatch (xgi::Input * in, xgi::Output * out)  throw (xgi::exception::Exception)
{
  cgicc::Cgicc cgi(in);
...
void EmuTFMonitor::showStatus (xgi::Input * in, xgi::Output * out)  throw (xgi::exception::Exception)
{
...
void EmuTFMonitor::printParametersTable( xgi::Output * out ) throw (xgi::exception::Exception)
{
...
/*
  std::string EmuTFMonitor::ageOfPageClock(){
  std::stringstream ss;
