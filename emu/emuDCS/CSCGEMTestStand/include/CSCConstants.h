...
{
     enum dcfebs {NUM_DCFEBS_ME11 = 7, NUM_DCFEBS_NONME11 =5};
     enum layer_info  {NUM_LAYERS = 6, KeyLayer = 3};
     enum gemfibers {NUM_FIBERS_GE11 = 4, NUM_FIBERS_GE21 = 7};
     enum gemcluster {CLUSTER_BITS_GE11 = 14};
     enum clctpatterns_info {NUM_PATTERNS = 11};
     enum strips_info {NUM_HSPERDCFEB = 32, NUM_HS_ME1B = 128, NUM_HS_ME1A = 96, NUM_HS = 224, NUM_STRIPS = 112, NUM_DISTRIPS = 56, NUM_HS_NONME11 = 160};
