...
class ConfigurationEditor: public xdaq::Application
{
public:
  ...
  void getConfigIdInfos(std::vector<ConfigIDInfo> &configIDs, const std::string endcap_side) throw (xcept::Exception);
  ...
  std::string configIDOptionsWithDescription(std::vector<ConfigIDInfo> &configIDs);
