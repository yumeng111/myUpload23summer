...
namespace
{
  const std::string default_conf_type = "GLOBAL";
  const std::string default_conf_description = "none";
}
...
EmuPCrateConfigTStore::EmuPCrateConfigTStore(xdaq::ApplicationStub * s) throw (xdaq::exception::Exception) :
  emu::db::ConfigurationEditor(s)
{
  ...
  infoSpace->fireItemAvailable("tstoreViewXML", &tstoreViewXML_);
  std::cout<<"constr tstoreViewXML_ = "<<tstoreViewXML_.toString()<<std::endl;
  hierarchy_ = 0;
  ...
  config_desc_ = default_conf_description;
}
...
std::string EmuPCrateConfigTStore::elementNameFromTableName(const std::string &tableName)
{
...
std::string EmuPCrateConfigTStore::attributeNameFromColumnName(const std::string &column)
{
...
bool EmuPCrateConfigTStore::shouldDisplayInHex(const std::string &columnName)
{
...
bool EmuPCrateConfigTStore::canChangeColumnGlobally(const std::string &columnName, const std::string &tableName)
{
...
bool EmuPCrateConfigTStore::columnIsUniqueIdentifier(const std::string &columnName, const std::string &tableName)
{
  return columnIsDatabaseOnly(columnName, tableName);
}


bool EmuPCrateConfigTStore::columnIsDatabaseOnly(const std::string &columnName, const std::string &tableName)
{
  return columnName.find("CONFIG_ID") != std::string::npos;
}


bool EmuPCrateConfigTStore::canChangeColumn(const std::string &columnName, const std::string &tableName)
{
...
void EmuPCrateConfigTStore::outputStandardInterface(xgi::Output * out)
{
  using std::endl;
  using cgicc::table;
  using cgicc::fieldset;
  using cgicc::form;
  using cgicc::input;
  using cgicc::br;

  // initialize PCCrate hierarchy from TStore configuration XML:
  tstoreViewXML_.fromString(emu::utils::performExpansions(tstoreViewXML_));
  std::cout<<"tstoreViewXML_ = "<<tstoreViewXML_.toString()<<std::endl;
  if (hierarchy_ == 0) hierarchy_ = new emu::db::PCConfigHierarchy(tstoreViewXML_.toString());
 ...
 *out << fieldset() << br();
  ...
  *out << form().set("method", "GET").set("action", urn + "selectVersion") << endl;
  *out << "<table border=\"0\" cellpadding=\"0\"><tr><td>";
  outputEndcapSelector(out);

  *out << "</td><td>" << input().set("type", "submit").set("value", "Read version...").set("style", "width:120px;") << "</td></tr></table>" << endl;
  *out << form() << cgicc::td() << endl;

  *out << cgicc::td().set("style", "width:130px;");
  *out << form().set("method", "GET").set("action", urn + "selectVersions") << endl;
  *out << "<table border=\"0\" cellpadding=\"0\"><tr><td>";
  outputEndcapSelector(out);
  *out << "</td><td>" << input().set("type", "submit").set("value", "Compare versions...") << "</td></tr></table>" << endl;
  *out << form() << endl;
  *out << cgicc::td() << endl;
  ...
  *out << cgicc::td().set("style", "width:130px;");
  *out << form().set("method","GET").set("action", urn + "sync") << endl;
  *out << input().set("type","submit").set("value","Sync to DB").set("style", "width:120px;") << endl;
  *out << form() << endl;
  *out << cgicc::td();
#endif
  ...
  *out << fieldset().set("style", "font-size: 11pt; font-family: arial;");
  *out << cgicc::legend("Load from XML file").set("style", "color:blue") << endl;
  outputFileSelector(out);
  *out << form().set("method", "GET").set("action", urn + "parse") << endl;
  *out << input().set("type", "submit").set("value", "Parse XML file").set("style", "width:120px;") << endl;
  *out << form() << endl;
  *out << fieldset() << br();


  *out << fieldset().set("style", "font-size: 11pt; font-family: arial;");
  *out << cgicc::legend("Upload").set("style", "color:blue") << endl;

  *out << "<table border=\"0\" cellpadding=\"1\">" << endl;

  *out << form().set("method", "GET").set("action", urn + "SetTypeDesc") << endl;
  *out << "<tr><td align=\"right\">" << endl;
  *out << input().set("type", "submit").set("value", "Set Configuration Type") << endl;
  *out << "</td><td>" << endl;
  *out << input().set("type", "text").set("value", config_type_).set("name", "ConfigType") << endl;
  *out << "</td></tr> " << endl;
  *out << form() << endl;

  emu::db::ConfigIDInfo descr("","","",config_desc_);
  ...
  *out << "Current Config type: <i>" << config_type_ << "</i> &nbsp;&nbsp; ";
  *out << "Short description: <i>" << descr.shortDescription() << "</i>" << br() << endl;

  *out << table().set("border", "0").set("cellpadding", "3");
  *out << cgicc::tr();
  *out << cgicc::td().set("style", "width:130px;");
  *out << form().set("method", "GET").set("action", urn + "upload") << endl;
  *out << input().set("type", "submit").set("value", "Upload to DB").set("style", "width:120px;").set("onclick","return validateShortDescription()") << endl;
  *out << form() << cgicc::td() << endl;
  *out << cgicc::td().set("style", "width:130px;");
  *out << form().set("method", "GET").set("action", urn + "exportAsXML") << endl;
  *out << input().set("type", "submit").set("value", "Export as XML").set("style", "width:120px;") << endl;
  *out << form() << endl;
  *out << cgicc::td() << endl;
  *out << cgicc::tr();
  *out << table();
  ...
  *out << fieldset().set("style", "font-size: 11pt; font-family: arial;");
  *out << cgicc::legend("Timing Scan").set("style", "color:blue") << endl;

  *out << form().set("method", "POST").set("enctype", "multipart/form-data").set("action", urn + "SelectTestSummaryFile") << endl;
  *out << input().set("type", "file").set("name", "testSummaryFile").set("size", "90") << endl;
  *out << input().set("type", "submit").set("value", "Read") << endl;
  *out << form() << endl;

  //*out << cgicc::td().set("style", "width:130px;");
  *out << form().set("method", "GET").set("action", urn + "parseTestSummary") << endl;
  *out << input().set("type", "submit").set("value", "Parse Timing Scan") << endl;
  *out << form() << endl;
  //*out << cgicc::td();
...
void EmuPCrateConfigTStore::simpleDiff(
...
void EmuPCrateConfigTStore::simpleCrateDiff(
    const std::string &queryViewName,
    const std::string &connectionID,
    const std::string &old_emu_config_id,
...
void EmuPCrateConfigTStore::diffCrate(
    const std::string &connectionID,
    const std::string &old_emu_config_id,
...
void EmuPCrateConfigTStore::SetTypeDesc(xgi::Input * in, xgi::Output * out) throw (xgi::exception::Exception)
{
  cgicc::Cgicc cgi(in);
  cgicc::form_iterator name_type = cgi.getElement("ConfigType");

  if (name_type != cgi.getElements().end())
  {
    config_type_ = cgi["ConfigType"]->getValue();
    std::cout << "Type " << config_type_ << std::endl;
  }

  cgicc::form_iterator name_short = cgi.getElement("ShortConfigDesc");
  cgicc::form_iterator name_long = cgi.getElement("LongConfigDesc");

  if (name_short != cgi.getElements().end())
  {
    std::string desc_short = cgi["ShortConfigDesc"]->getValue();
    std::string desc_long;
    if (name_long != cgi.getElements().end())
    {
      desc_long = cgi["LongConfigDesc"]->getValue();
    }

    config_desc_ = emu::db::ConfigIDInfo::encodeDescription(desc_short, desc_long);
...
void EmuPCrateConfigTStore::checkLine(
    std::istream &input,
...
bool EmuPCrateConfigTStore::parseTestSummaryChamber(std::istringstream &testSummary, xdata::Table &tmbChanges,int &TTCrxID,std::string &chamberName) throw (xdaq::exception::Exception)
{
  ...
  for (std::vector<std::string>::iterator column = columns.begin(); column != columns.end(); ++column)
  {
    if (!isNumericType(tmbChanges.getColumnType(*column)))   tmbChanges.removeColumn(*column);
  }
  tmbChanges.append();
  chamberName = "";
...
xdata::Table &EmuPCrateConfigTStore::valueForKeyContaining(
...
std::string EmuPCrateConfigTStore::keyContaining(
    std::map<std::string, xdata::Table> &haystack,
    const std::string &needle) throw (xdaq::exception::Exception)
{
...
void EmuPCrateConfigTStore::applyTestSummary(xgi::Input * in, xgi::Output * out) throw (xgi::exception::Exception)
{
  ...
  try
  {
    ...
    {
      xdata::Table &ccbTableToChange = emu::db::ConfigurationEditor::getCachedTable(std::string("ccb"), rxID->first);
...
void EmuPCrateConfigTStore::setCachedTable(
...
void EmuPCrateConfigTStore::setCachedDiff(
    const std::string &insertViewName,
    int crateID,
    xdata::Table &table
    /*,xdata::UnsignedInteger64 &_vcc_config_id*//*,Crate *thisCrate*/) throw (xcept::Exception)
...
xdata::UnsignedInteger64 EmuPCrateConfigTStore::getConfigId(
...
void EmuPCrateConfigTStore::queryMaxId(
    const std::string &connectionID,
    const std::string &queryViewName,
    const std::string &dbTable,
    const std::string &dbColumn,
...
void EmuPCrateConfigTStore::diff(
    const std::string &connectionID,
    const std::string &queryViewName,
    const std::string &old_emu_config_id,
    const std::string &new_emu_config_id,
...
void EmuPCrateConfigTStore::query(
    const std::string &connectionID,
    const std::string &queryViewName,
...
void EmuPCrateConfigTStore::insert(
    const std::string &connectionID,
    const std::string &insertViewName,
...
{
  emu::db::ConfigurationEditor::getTableDefinitions(connectionID);
...
void EmuPCrateConfigTStore::setConfigID(
    xdata::Table &newRows,
    size_t rowId,
...
void EmuPCrateConfigTStore::startUpload(xgi::Input * in) throw (xcept::Exception)
{
  // Processing DOM Tree
  if (TStore_myEndcap_)
  {
...
void EmuPCrateConfigTStore::uploadConfiguration(
    const std::string &connectionID,
    const std::string endcap_side) throw (xcept::Exception)
{
...
void EmuPCrateConfigTStore::copyPeripheralCrateToTable(xdata::Table &newRows, Crate * TStore_thisCrate)
{
...
void EmuPCrateConfigTStore::uploadPeripheralCrate(
    const std::string &connectionID,
...
void EmuPCrateConfigTStore::uploadCCB(
    const std::string &connectionID,
...
void EmuPCrateConfigTStore::uploadMPC(
    const std::string &connectionID,
    xdata::UnsignedInteger64 &periph_config_id,
    /*MPC * TStore_thisMPC*/
    int crateID) throw (xcept::Exception)
...
xdata::Table &EmuPCrateConfigTStore::getCachedDiff(
    const std::string &insertViewName,
    int crateID
    /*,xdata::UnsignedInteger64 &_vcc_config_id*//*,Crate *thisCrate*/) throw (xcept::Exception)
{
...
xdata::Table &EmuPCrateConfigTStore::getCachedTable(
    const std::string &insertViewName,
    int crateID
    /*,xdata::UnsignedInteger64 &_vcc_config_id*//*,Crate *thisCrate*/) throw (xcept::Exception)
{
...
void EmuPCrateConfigTStore::uploadVMECC(
    const std::string &connectionID,
    xdata::UnsignedInteger64 &periph_config_id,
...
void EmuPCrateConfigTStore::uploadCSC(
    const std::string &connectionID,
    xdata::UnsignedInteger64 &periph_config_id,
...
void EmuPCrateConfigTStore::uploadDAQMB(
    const std::string &connectionID,
...
void EmuPCrateConfigTStore::copyCFEBToTable(xdata::Table &newRows, DAQMB * TStore_thisDAQMB)
{
  ...
  {
    //std::cout << e.what() << std::endl;
    XCEPT_RETHROW(xgi::exception::Exception,"could not copy to CFEB",e);
  }
  catch (xcept::Exception &e)
  {
    //std::cout << e.what() << std::endl;
...
void EmuPCrateConfigTStore::uploadCFEB(
    const std::string &connectionID,
...
void EmuPCrateConfigTStore::copyTMBToTable(xdata::Table &newRows, TMB * TStore_thisTMB)
{
  try
  {
    ...
    std::string GEM_RX_DELAY("GEM_RX_DELAY");
    ...
    std::string GEM_FIFO_DECOUPLE("GEM_FIFO_DECOUPLE");
    ...
    std::string GEM_ALCT_DELTAWIRE_EVEN("GEM_ALCT_DELTAWIRE_EVEN");
    std::string GEM_ALCT_DELTAWIRE_ODD("GEM_ALCT_DELTAWIRE_ODD");
    std::string GEM_CLCT_DELTAHS_EVEN("GEM_CLCT_DELTAHS_EVEN");
    std::string GEM_CLCT_DELTAHS_ODD("GEM_CLCT_DELTAHS_ODD");
    std::string GEM_MATCH_DELTAPAD("GEM_MATCH_DELTAPAD");
    std::string GEM_MATCH_NEIGHBORPAD("GEM_MATCH_NEIGHBORPAD");
    std::string GEM_MATCH_NEIGHBORROLL("GEM_MATCH_NEIGHBORROLL");
    std::string GEM_ME1A_MATCH_ENABLE("GEM_ME1A_MATCH_ENABLE");
    std::string GEM_ME1B_MATCH_ENABLE("GEM_ME1B_MATCH_ENABLE");
    std::string GEMA_BX0_DELAY("GEMA_BX0_DELAY");
    std::string GEMA_BX0_ENABLE("GEMA_BX0_ENABLE");
    std::string GEMA_FIBER_ENABLE("GEMA_FIBER_ENABLE");
    std::string GEMA_MATCH_IGNORE_POSITION("GEMA_MATCH_IGNORE_POSITION");
    std::string GEMB_BX0_DELAY("GEMB_BX0_DELAY");
    std::string GEMB_BX0_ENABLE("GEMB_BX0_ENABLE");
    std::string GEMB_FIBER_ENABLE("GEMB_FIBER_ENABLE");
    std::string GEMB_MATCH_IGNORE_POSITION("GEMB_MATCH_IGNORE_POSITION");
    std::string GEMCSC_BEND_ENABLE("GEMCSC_BEND_ENABLE");
    std::string GEMCSC_IGNORE_BEND_CHECK("GEMCSC_IGNORE_BEND_CHECK");
    std::string GEMCSC_MATCH_BEND_CORRECTION("GEMCSC_MATCH_BEND_CORRECTION");
    std::string GEMCSC_MATCH_EXTRAPOLATE("GEMCSC_MATCH_EXTRAPOLATE");
    std::string GEMCSC_MATCH_TIGHTWINDOW("GEMCSC_MATCH_TIGHTWINDOW");
    std::string MATCH_DROP_LOWQALCT("MATCH_DROP_LOWQALCT");
    std::string MATCH_GEM_ALCT_DELAY("MATCH_GEM_ALCT_DELAY");
    std::string MATCH_GEM_ALCT_WINDOW("MATCH_GEM_ALCT_WINDOW");
    std::string MATCH_GEM_CLCT_WINDOW("MATCH_GEM_CLCT_WINDOW");
    std::string ME1A_MATCH_DROP_LOWQCLCT("ME1A_MATCH_DROP_LOWQCLCT");
    std::string ME1B_MATCH_DROP_LOWQCLCT("ME1B_MATCH_DROP_LOWQCLCT");
    std::string HMT_AFF_THRESH("HMT_AFF_THRESH");
    std::string HMT_ALCT_WIN_SIZE("HMT_ALCT_WIN_SIZE");
    std::string HMT_ALLOW_ANODE("HMT_ALLOW_ANODE");
    std::string HMT_ALLOW_ANODE_RO("HMT_ALLOW_ANODE_RO");
    std::string HMT_ALLOW_CATHODE("HMT_ALLOW_CATHODE");
    std::string HMT_ALLOW_CATHODE_RO("HMT_ALLOW_CATHODE_RO");
    std::string HMT_ALLOW_MATCH("HMT_ALLOW_MATCH");
    std::string HMT_ALLOW_MATCH_RO("HMT_ALLOW_MATCH_RO");
    std::string HMT_DELAY("HMT_DELAY");
    std::string HMT_ENABLE("HMT_ENABLE");
    std::string HMT_ME1A_ENABLE("HMT_ME1A_ENABLE");
    std::string HMT_OUTTIME_CHECK("HMT_OUTTIME_CHECK");
    std::string HMT_THRESH1("HMT_THRESH1");
    std::string HMT_THRESH2("HMT_THRESH2");
    std::string HMT_THRESH3("HMT_THRESH3");
    std::string CFEB_ALLOW_HMT_RO("CFEB_ALLOW_HMT_RO");
    std::string RUN2_REVCODE_ENABLE("RUN2_REVCODE_ENABLE");
    std::string RUN3_ALCT_DATAFORMAT_ENABLE("RUN3_ALCT_DATAFORMAT_ENABLE");
    std::string RUN3_DAQ_DATAFORMAT_ENABLE("RUN3_DAQ_DATAFORMAT_ENABLE");
    std::string RUN3_TRIG_DATAFORMAT_ENABLE("RUN3_TRIG_DATAFORMAT_ENABLE");
    std::string SEQ_TRIGGER_NODEADTIME("SEQ_TRIGGER_NODEADTIME");
    std::string TMB_COPAD_ALCT_ALLOW("TMB_COPAD_ALCT_ALLOW");
    std::string TMB_COPAD_ALCT_ALLOW_RO("TMB_COPAD_ALCT_ALLOW_RO");
    std::string TMB_COPAD_CLCT_ALLOW("TMB_COPAD_CLCT_ALLOW");
    std::string TMB_COPAD_CLCT_ALLOW_RO("TMB_COPAD_CLCT_ALLOW_RO");
    std::string GEMA_VFAT_HCM("GEMA_VFAT_HCM");
    std::string GEMB_VFAT_HCM("GEMB_VFAT_HCM");
    ...
    xdata::UnsignedShort  _gem_rx_delay			= TStore_thisTMB->GetGemRxClockDelay();
    ...
    xdata::UnsignedShort  _gem_fifo_decouple			= TStore_thisTMB->GetGemDecoupleTbins();
    ...
    xdata::UnsignedShort  _gem_alct_deltawire_even = TStore_thisTMB->GetGemAlctDeltawireEven();
    xdata::UnsignedShort  _gem_alct_deltawire_odd = TStore_thisTMB->GetGemAlctDeltawireOdd();
    xdata::UnsignedShort  _gem_clct_deltahs_even = TStore_thisTMB->GetGemClctDeltahsEven();
    xdata::UnsignedShort  _gem_clct_deltahs_odd = TStore_thisTMB->GetGemClctDeltahsOdd();
    xdata::UnsignedShort  _gem_fifo_rxd_int_delay = TStore_thisTMB->GetGemRxdIntDelay();
    xdata::UnsignedShort  _gem_match_deltapad = TStore_thisTMB->GetGemMatchDeltaPad();
    xdata::UnsignedShort  _gem_match_neighborpad = TStore_thisTMB->GetGemMatchNeighborPad();
    xdata::UnsignedShort  _gem_match_neighborroll = TStore_thisTMB->GetGemMatchNeighborRoll();
    xdata::UnsignedShort  _gem_me1a_match_enable = TStore_thisTMB->GetGemMe1aMatchEnable();
    xdata::UnsignedShort  _gem_me1b_match_enable = TStore_thisTMB->GetGemMe1bMatchEnable();
    xdata::UnsignedShort  _gema_bx0_delay = TStore_thisTMB->GetGemABx0Delay();
    xdata::UnsignedShort  _gema_bx0_enable = TStore_thisTMB->GetGemABx0Enable();
    xdata::UnsignedShort  _gema_fiber_enable = TStore_thisTMB->GetGemAFiberEnable();
    xdata::UnsignedShort  _gema_match_ignore_position = TStore_thisTMB->GetGemAMatchIgnorePosition();
    xdata::UnsignedShort  _gemb_bx0_delay = TStore_thisTMB->GetGemBBx0Delay();
    xdata::UnsignedShort  _gemb_bx0_enable = TStore_thisTMB->GetGemBBx0Enable();
    xdata::UnsignedShort  _gemb_fiber_enable = TStore_thisTMB->GetGemBFiberEnable();
    xdata::UnsignedShort  _gemb_match_ignore_position = TStore_thisTMB->GetGemBMatchIgnorePosition();
    xdata::UnsignedShort  _gemcsc_bend_enable = TStore_thisTMB->GetGemcscBendEnable();
    xdata::UnsignedShort  _gemcsc_ignore_bend_check = TStore_thisTMB->GetGemcscIgnoreBendCheck();
    xdata::UnsignedShort  _gemcsc_match_bend_correction = TStore_thisTMB->GetGemcscMatchBendCorrection();
    xdata::UnsignedShort  _gemcsc_match_extrapolate = TStore_thisTMB->GetGemcscMatchExtrapolate();
    xdata::UnsignedShort  _gemcsc_match_tightwindow = TStore_thisTMB->GetGemcscMatchTightwindow();
    xdata::UnsignedShort  _match_drop_lowqalct = TStore_thisTMB->GetMatchDropLowqalct();
    xdata::UnsignedShort  _match_gem_alct_delay = TStore_thisTMB->GetMatchGemAlctDelay();
    xdata::UnsignedShort  _match_gem_alct_window = TStore_thisTMB->GetMatchGemAlctWindow();
    xdata::UnsignedShort  _match_gem_clct_window = TStore_thisTMB->GetMatchGemClctWindow();
    xdata::UnsignedShort  _me1a_match_drop_lowqclct = TStore_thisTMB->GetMe1aMatchDropLowqclct();
    xdata::UnsignedShort  _me1b_match_drop_lowqclct = TStore_thisTMB->GetMe1bMatchDropLowqclct();
    xdata::UnsignedShort  _hmt_aff_thresh = TStore_thisTMB->GetHmtAffThresh();
    xdata::UnsignedShort  _hmt_alct_win_size = TStore_thisTMB->GetHmtAlctWinSize();
    xdata::UnsignedShort  _hmt_allow_anode = TStore_thisTMB->GetHmtAllowAnode();
    xdata::UnsignedShort  _hmt_allow_anode_ro = TStore_thisTMB->GetHmtAllowAnodeRo();
    xdata::UnsignedShort  _hmt_allow_cathode = TStore_thisTMB->GetHmtAllowCathode();
    xdata::UnsignedShort  _hmt_allow_cathode_ro = TStore_thisTMB->GetHmtAllowCathodeRo();
    xdata::UnsignedShort  _hmt_allow_match = TStore_thisTMB->GetHmtAllowMatch();
    xdata::UnsignedShort  _hmt_allow_match_ro = TStore_thisTMB->GetHmtAllowMatchRo();
    xdata::UnsignedShort  _hmt_delay = TStore_thisTMB->GetHmtDelay();
    xdata::UnsignedShort  _hmt_enable = TStore_thisTMB->Gethmt_enable();
    xdata::UnsignedShort  _hmt_me1a_enable = TStore_thisTMB->Gethmt_me1a_enable();
    xdata::UnsignedShort  _hmt_outtime_check = TStore_thisTMB->GetHmtOuttimeCheck();
    xdata::UnsignedShort  _hmt_thresh1 = TStore_thisTMB->GetHmtThresh1();
    xdata::UnsignedShort  _hmt_thresh2 = TStore_thisTMB->GetHmtThresh2();
    xdata::UnsignedShort  _hmt_thresh3 = TStore_thisTMB->GetHmtThresh3();
    xdata::UnsignedShort  _cfeb_allow_hmt_ro = TStore_thisTMB->GetCfebAllowHmtRo();
    xdata::UnsignedShort  _run2_revcode_enable = TStore_thisTMB->Getrun2_revcode_enable();
    xdata::UnsignedShort  _run3_alct_dataformat_enable = TStore_thisTMB->Getrun3_alct_dataformat_enable();
    xdata::UnsignedShort  _run3_daq_dataformat_enable = TStore_thisTMB->Getrun3_daq_dataformat_enable();
    xdata::UnsignedShort  _run3_trig_dataformat_enable = TStore_thisTMB->Getrun3_trig_dataformat_enable();
    xdata::UnsignedShort  _seq_trigger_nodeadtime = TStore_thisTMB->Get_seq_trigger_nodeadtime();
    xdata::UnsignedShort  _tmb_copad_alct_allow = TStore_thisTMB->GetTmbCopadAlctAllow();
    ...
    {
       std::stringstream hcm;
       hcm << std::hex << TStore_thisTMB->GetGemVfatHotChannelMask(false) << std::dec;
       _gemb_vfat_hcm =  hcm.str();
    }

    // Liu 2021-10-01: TODO: TMB class doesn't have Get method for gema_vfat_hcm and gemb_vfat_hcm
    ...
    newRows.setValueAt(rowId, GEM_RX_DELAY	, _gem_rx_delay);
    ...
    newRows.setValueAt(rowId, GEM_FIFO_DECOUPLE	, _gem_fifo_decouple);
    ...
    newRows.setValueAt(rowId, GEM_ALCT_DELTAWIRE_EVEN , _gem_alct_deltawire_even);
    ...
    newRows.setValueAt(rowId, GEM_ME1A_MATCH_ENABLE , _gem_me1a_match_enable);
    newRows.setValueAt(rowId, GEM_ME1B_MATCH_ENABLE , _gem_me1b_match_enable);
    newRows.setValueAt(rowId, GEMA_BX0_DELAY , _gema_bx0_delay);
    newRows.setValueAt(rowId, GEMA_BX0_ENABLE , _gema_bx0_enable);
    newRows.setValueAt(rowId, GEMA_FIBER_ENABLE , _gema_fiber_enable);
    newRows.setValueAt(rowId, GEMA_MATCH_IGNORE_POSITION , _gema_match_ignore_position);
    newRows.setValueAt(rowId, GEMB_BX0_DELAY , _gemb_bx0_delay);
    newRows.setValueAt(rowId, GEMB_BX0_ENABLE , _gemb_bx0_enable);
    newRows.setValueAt(rowId, GEMB_FIBER_ENABLE , _gemb_fiber_enable);
    newRows.setValueAt(rowId, GEMB_MATCH_IGNORE_POSITION , _gemb_match_ignore_position);
    newRows.setValueAt(rowId, GEMCSC_BEND_ENABLE , _gemcsc_bend_enable);
    newRows.setValueAt(rowId, GEMCSC_IGNORE_BEND_CHECK , _gemcsc_ignore_bend_check);
    newRows.setValueAt(rowId, GEMCSC_MATCH_BEND_CORRECTION , _gemcsc_match_bend_correction);
    newRows.setValueAt(rowId, GEMCSC_MATCH_EXTRAPOLATE , _gemcsc_match_extrapolate);
    newRows.setValueAt(rowId, GEMCSC_MATCH_TIGHTWINDOW , _gemcsc_match_tightwindow);
    newRows.setValueAt(rowId, MATCH_DROP_LOWQALCT , _match_drop_lowqalct);
    newRows.setValueAt(rowId, MATCH_GEM_ALCT_DELAY , _match_gem_alct_delay);
    newRows.setValueAt(rowId, MATCH_GEM_ALCT_WINDOW , _match_gem_alct_window);
    newRows.setValueAt(rowId, MATCH_GEM_CLCT_WINDOW , _match_gem_clct_window);
    newRows.setValueAt(rowId, ME1A_MATCH_DROP_LOWQCLCT , _me1a_match_drop_lowqclct);
    newRows.setValueAt(rowId, ME1B_MATCH_DROP_LOWQCLCT , _me1b_match_drop_lowqclct);
    newRows.setValueAt(rowId, HMT_AFF_THRESH , _hmt_aff_thresh);
    newRows.setValueAt(rowId, HMT_ALCT_WIN_SIZE , _hmt_alct_win_size);
    newRows.setValueAt(rowId, HMT_ALLOW_ANODE , _hmt_allow_anode);
    newRows.setValueAt(rowId, HMT_ALLOW_ANODE_RO , _hmt_allow_anode_ro);
    newRows.setValueAt(rowId, HMT_ALLOW_CATHODE , _hmt_allow_cathode);
    newRows.setValueAt(rowId, HMT_ALLOW_CATHODE_RO , _hmt_allow_cathode_ro);
    newRows.setValueAt(rowId, HMT_ALLOW_MATCH , _hmt_allow_match);
    newRows.setValueAt(rowId, HMT_ALLOW_MATCH_RO , _hmt_allow_match_ro);
    newRows.setValueAt(rowId, HMT_DELAY , _hmt_delay);
    newRows.setValueAt(rowId, HMT_ENABLE , _hmt_enable);
    newRows.setValueAt(rowId, HMT_ME1A_ENABLE , _hmt_me1a_enable);
    newRows.setValueAt(rowId, HMT_OUTTIME_CHECK , _hmt_outtime_check);
    newRows.setValueAt(rowId, HMT_THRESH1 , _hmt_thresh1);
    newRows.setValueAt(rowId, HMT_THRESH2 , _hmt_thresh2);
    newRows.setValueAt(rowId, HMT_THRESH3 , _hmt_thresh3);
    newRows.setValueAt(rowId, CFEB_ALLOW_HMT_RO , _cfeb_allow_hmt_ro);
    newRows.setValueAt(rowId, RUN2_REVCODE_ENABLE , _run2_revcode_enable);
    newRows.setValueAt(rowId, RUN3_ALCT_DATAFORMAT_ENABLE , _run3_alct_dataformat_enable);
    newRows.setValueAt(rowId, RUN3_DAQ_DATAFORMAT_ENABLE , _run3_daq_dataformat_enable);
    newRows.setValueAt(rowId, RUN3_TRIG_DATAFORMAT_ENABLE , _run3_trig_dataformat_enable);
    newRows.setValueAt(rowId, SEQ_TRIGGER_NODEADTIME , _seq_trigger_nodeadtime);
    newRows.setValueAt(rowId, TMB_COPAD_ALCT_ALLOW , _tmb_copad_alct_allow);
    newRows.setValueAt(rowId, TMB_COPAD_ALCT_ALLOW_RO , _tmb_copad_alct_allow_ro);
    newRows.setValueAt(rowId, TMB_COPAD_CLCT_ALLOW , _tmb_copad_clct_allow);
    newRows.setValueAt(rowId, TMB_COPAD_CLCT_ALLOW_RO , _tmb_copad_clct_allow_ro);
    newRows.setValueAt(rowId, GEMA_VFAT_HCM , _gema_vfat_hcm);
    newRows.setValueAt(rowId, GEMB_VFAT_HCM , _gemb_vfat_hcm);
  }
  catch (xcept::Exception &e)
  {
    std::cout << e.what() << std::endl;
...
void EmuPCrateConfigTStore::uploadTMB(
    const std::string &connectionID,
    xdata::UnsignedInteger64 &csc_config_id,
    TMB * &TStore_thisTMB,
    int slot,
...
void EmuPCrateConfigTStore::uploadALCT(
    const std::string &connectionID,
...
void EmuPCrateConfigTStore::uploadAnodeChannel(
    const std::string &connectionID,
...
void EmuPCrateConfigTStore::readConfiguration(
    const std::string &connectionID,
    const std::string &emu_config_id,
    EmuEndcap * endcap) throw (xcept::Exception)
{
  try
  {
    ...
    // reset type and description to the default values:
    config_type_ = default_conf_type;
    config_desc_ = default_conf_description;
  }
  catch (std::exception &e)
...
int EmuPCrateConfigTStore::readCrateID(xdata::Table &results, unsigned rowIndex) throw (xcept::Exception)
{
...
void EmuPCrateConfigTStore::readPeripheralCrate(
    const std::string &connectionID,
    const std::string &emu_config_id,
    EmuEndcap * endcap) throw (xcept::Exception)
{
...
void EmuPCrateConfigTStore::readVCC(
    const std::string &connectionID,
    const std::string &emu_config_id,
...
void EmuPCrateConfigTStore::diffCSC(
    const std::string &connectionID,
    const std::string &old_emu_config_id,
    const std::string &old_periph_config_id,
    const std::string &new_emu_config_id,
...
void EmuPCrateConfigTStore::readCSC(
    const std::string &connectionID,
    const std::string &emu_config_id,
    const std::string &periph_config_id,
    Crate * theCrate) throw (xcept::Exception)
{
  ...
  for (unsigned rowIndex = 0; rowIndex < results.getRowCount(); rowIndex++)
  {
    ...
    emu::db::ConfigurationEditor::setCachedTable(queryViewName,
        chamberID(theCrate->CrateID(), csc_->GetLabel()), correctedResults);
...
void EmuPCrateConfigTStore::readCCB(
    const std::string &connectionID,
    const std::string &emu_config_id,
    const std::string &periph_config_id,
    Crate * theCrate) throw (xcept::Exception)
...
void EmuPCrateConfigTStore::readMPC(
    const std::string &connectionID,
    const std::string &emu_config_id,
    const std::string &periph_config_id,
    Crate * theCrate) throw (xcept::Exception)
...
void EmuPCrateConfigTStore::diffDAQMB(
    const std::string &connectionID,
    const std::string &old_emu_config_id,
...
void EmuPCrateConfigTStore::readDAQMB(
    const std::string &connectionID,
    const std::string &emu_config_id,
...
void EmuPCrateConfigTStore::diffCFEB(
    const std::string &connectionID,
    const std::string &old_emu_config_id,
...
void EmuPCrateConfigTStore::diffAnodeChannel(
    const std::string &connectionID,
    const std::string &old_emu_config_id,
...
void EmuPCrateConfigTStore::readCFEB(
    const std::string &connectionID,
    const std::string &emu_config_id,
...
void EmuPCrateConfigTStore::diffTMB(
    const std::string &connectionID,
    const std::string &old_emu_config_id,
    const std::string &old_csc_config_id,
    const std::string &new_emu_config_id,
...
void EmuPCrateConfigTStore::readTMB(
    const std::string &connectionID,
    const std::string &emu_config_id,
    const std::string &csc_config_id,
    Crate * theCrate,
    Chamber * theChamber) throw (xcept::Exception)
{
  ...
  for (unsigned rowIndex = 0; rowIndex < results.getRowCount(); rowIndex++)
  {
    ...
    for (std::vector<std::string>::iterator column = columns.begin(); column != columns.end(); ++column)
    {
      ...
      if (*column == "GEM_RX_DELAY") tmb_->SetGemRxClockDelay(IntValue);
      ...
      if (*column == "GEM_FIFO_DECOUPLE") tmb_->SetGemDecoupleTbins(IntValue);
    ...
    if (*column == "GEM_ALCT_DELTAWIRE_EVEN")     tmb_->SetGemAlctDeltawireEven(IntValue);
    ...
    if (*column == "GEM_ME1A_MATCH_ENABLE")     tmb_->SetGemMe1aMatchEnable(IntValue);
    if (*column == "GEM_ME1B_MATCH_ENABLE")     tmb_->SetGemMe1bMatchEnable(IntValue);
    if (*column == "GEMA_BX0_DELAY")     tmb_->SetGemABx0Delay(IntValue);
    if (*column == "GEMA_BX0_ENABLE")     tmb_->SetGemABx0Enable(IntValue);
    if (*column == "GEMA_FIBER_ENABLE")     tmb_->SetGemAFiberEnable(IntValue);
    if (*column == "GEMA_MATCH_IGNORE_POSITION")  tmb_->SetGemAMatchIgnorePosition(IntValue);
    if (*column == "GEMB_BX0_DELAY")     tmb_->SetGemBBx0Delay(IntValue);
    if (*column == "GEMB_BX0_ENABLE")     tmb_->SetGemBBx0Enable(IntValue);
    if (*column == "GEMB_FIBER_ENABLE")     tmb_->SetGemBFiberEnable(IntValue);
    if (*column == "GEMB_MATCH_IGNORE_POSITION")  tmb_->SetGemBMatchIgnorePosition(IntValue);
    if (*column == "GEMCSC_BEND_ENABLE")     tmb_->SetGemcscBendEnable(IntValue);
    if (*column == "GEMCSC_IGNORE_BEND_CHECK")  tmb_->SetGemcscIgnoreBendCheck(IntValue);
    if (*column == "GEMCSC_MATCH_BEND_CORRECTION")  tmb_->SetGemcscMatchBendCorrection(IntValue);
    if (*column == "GEMCSC_MATCH_EXTRAPOLATE")     tmb_->SetGemcscMatchExtrapolate(IntValue);
    if (*column == "GEMCSC_MATCH_TIGHTWINDOW")     tmb_->SetGemcscMatchTightwindow(IntValue);
    if (*column == "MATCH_DROP_LOWQALCT")     tmb_->SetMatchDropLowqalct(IntValue);
    if (*column == "MATCH_GEM_ALCT_DELAY")     tmb_->SetMatchGemAlctDelay(IntValue);
    if (*column == "MATCH_GEM_ALCT_WINDOW")     tmb_->SetMatchGemAlctWindow(IntValue);
    if (*column == "MATCH_GEM_CLCT_WINDOW")     tmb_->SetMatchGemClctWindow(IntValue);
    if (*column == "ME1A_MATCH_DROP_LOWQCLCT")     tmb_->SetMe1aMatchDropLowqclct(IntValue);
    if (*column == "ME1B_MATCH_DROP_LOWQCLCT")     tmb_->SetMe1bMatchDropLowqclct(IntValue);
    if (*column == "HMT_AFF_THRESH")     tmb_->SetHmtAffThresh(IntValue);
    if (*column == "HMT_ALCT_WIN_SIZE")     tmb_->SetHmtAlctWinSize(IntValue);
    if (*column == "HMT_ALLOW_ANODE")     tmb_->SetHmtAllowAnode(IntValue);
    if (*column == "HMT_ALLOW_ANODE_RO")     tmb_->SetHmtAllowAnodeRo(IntValue);
    if (*column == "HMT_ALLOW_CATHODE")     tmb_->SetHmtAllowCathode(IntValue);
    if (*column == "HMT_ALLOW_CATHODE_RO")     tmb_->SetHmtAllowCathodeRo(IntValue);
    if (*column == "HMT_ALLOW_MATCH")     tmb_->SetHmtAllowMatch(IntValue);
    if (*column == "HMT_ALLOW_MATCH_RO")     tmb_->SetHmtAllowMatchRo(IntValue);
    if (*column == "HMT_DELAY")     tmb_->SetHmtDelay(IntValue);
    if (*column == "HMT_ENABLE")     tmb_->Sethmt_enable(IntValue);
    if (*column == "HMT_ME1A_ENABLE")     tmb_->Sethmt_me1a_enable(IntValue);
    if (*column == "HMT_OUTTIME_CHECK")     tmb_->SetHmtOuttimeCheck(IntValue);
    if (*column == "HMT_THRESH1")     tmb_->SetHmtThresh1(IntValue);
    if (*column == "HMT_THRESH2")     tmb_->SetHmtThresh2(IntValue);
    if (*column == "HMT_THRESH3")     tmb_->SetHmtThresh3(IntValue);
    if (*column == "CFEB_ALLOW_HMT_RO")     tmb_->SetCfebAllowHmtRo(IntValue);
    if (*column == "RUN2_REVCODE_ENABLE")     tmb_->Setrun2_revcode_enable(IntValue);
    if (*column == "RUN3_ALCT_DATAFORMAT_ENABLE")     tmb_->Setrun3_alct_dataformat_enable(IntValue);
    if (*column == "RUN3_DAQ_DATAFORMAT_ENABLE")     tmb_->Setrun3_daq_dataformat_enable(IntValue);
    if (*column == "RUN3_TRIG_DATAFORMAT_ENABLE")     tmb_->Setrun3_trig_dataformat_enable(IntValue);
    if (*column == "SEQ_TRIGGER_NODEADTIME")     tmb_->Set_seq_trigger_nodeadtime(IntValue);
    if (*column == "TMB_COPAD_ALCT_ALLOW")     tmb_->SetTmbCopadAlctAllow(IntValue);
    if (*column == "TMB_COPAD_ALCT_ALLOW_RO")  tmb_->SetTmbCopadAlctAllowRo(IntValue);
    if (*column == "TMB_COPAD_CLCT_ALLOW")     tmb_->SetTmbCopadClctAllow(IntValue);
    if (*column == "TMB_COPAD_CLCT_ALLOW_RO")  tmb_->SetTmbCopadClctAllowRo(IntValue);
    if (*column == "GEMA_VFAT_HCM")  {  sscanf(StrgValue.c_str(), "%x", &IntValue);   tmb_->SetGemVfatHotChannelMask (IntValue, true ); }
    if (*column == "GEMB_VFAT_HCM")  {  sscanf(StrgValue.c_str(), "%x", &IntValue);   tmb_->SetGemVfatHotChannelMask (IntValue,false ); }
...
void EmuPCrateConfigTStore::diffALCT(
    const std::string &connectionID,
    const std::string &old_emu_config_id,
...
void EmuPCrateConfigTStore::readALCT(
    const std::string &connectionID,
    const std::string &emu_config_id,
...
void EmuPCrateConfigTStore::readAnodeChannel(
    const std::string &connectionID,
    const std::string &emu_config_id,
...
std::string EmuPCrateConfigTStore::displayName(
    ...
    xdata::Table &data)
{
  ...
  return emu::db::ConfigurationEditor::displayName(configName, identifier, data);
}
