...
void emu::pc::LocalDAQInterface::takeRun( string type, unsigned int durationInSec ){
...
bool emu::pc::LocalDAQInterface::waitForDAQToExecute( const string command, const uint64_t seconds ){
  ...
  LOG4CPLUS_ERROR( parent_->getApplicationLogger(), "Timeout after waiting " << seconds << " sec for local DAQ to get " << expectedState 
