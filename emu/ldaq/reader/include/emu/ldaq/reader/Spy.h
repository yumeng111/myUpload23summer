...
namespace emu { namespace ldaq { namespace reader {
  ...
  /// An emu::ldaq::reader for reading from spy channel.
  class Spy : public emu::ldaq::reader::Base
  {
  public:
    ...
    enum Status_t {
      ...
      HeaderMissing     = 0x0040,	///< FED header is missing; set by emu::ldaq::rui
      TrailerMissing    = 0x0080	///< FED trailer is missing; set by emu::ldaq::rui
    };

    /// constructor

    /// @param filename Linux device to read from
    /// @param format format [ emu::ldaq::reader::Base::DDU | emu::ldaq::reader::Base::DCC ]
  ...
  protected:
    ...
    emu::ldaq::reader::Clock *ec;			///< used for timing periodic debug prints
    emu::ldaq::reader::Clock *ec1;			///< used for timing periodic debug prints
    emu::ldaq::reader::Clock *ec2;			///< used for timing periodic debug prints
    emu::ldaq::reader::Clock *ec3;			///< used for timing periodic debug prints
    emu::ldaq::reader::Clock *ec4;			///< used for timing periodic debug prints
    // DEBUG END
