...
emu::ldaq::rui::STEPEventCounter::STEPEventCounter(){
...
void emu::ldaq::rui::STEPEventCounter::reset(){
...
bool emu::ldaq::rui::STEPEventCounter::isNeededEvent( char* const DDUHeader ){
...
uint64_t emu::ldaq::rui::STEPEventCounter::getCount( const int dduInputIndex ) const {
  if ( 0 <= dduInputIndex && dduInputIndex < maxDDUInputs_ ) return count_[dduInputIndex];
  return 0;
}

uint64_t emu::ldaq::rui::STEPEventCounter::getCountRead( const int dduInputIndex ) const {
  if ( 0 <= dduInputIndex && dduInputIndex < maxDDUInputs_ ) return countRead_[dduInputIndex];
  return 0;
}

bool emu::ldaq::rui::STEPEventCounter::isLiveInput( const int dduInputIndex ) const {
  if ( 0 <= dduInputIndex && dduInputIndex < maxDDUInputs_ ) return isLiveInput_[dduInputIndex];
  return false;
}

void emu::ldaq::rui::STEPEventCounter::maskInput( const int dduInputIndex ){
  if ( 0 <= dduInputIndex && dduInputIndex < maxDDUInputs_ ) isMaskedInput_[dduInputIndex] = true;
}

void emu::ldaq::rui::STEPEventCounter::unmaskInput( const int dduInputIndex ){
  if ( 0 <= dduInputIndex && dduInputIndex < maxDDUInputs_ ) isMaskedInput_[dduInputIndex] = false;
}

bool emu::ldaq::rui::STEPEventCounter::isMaskedInput( const int dduInputIndex ) const {
  if ( 0 <= dduInputIndex && dduInputIndex < maxDDUInputs_ ) return isMaskedInput_[dduInputIndex];
  return false;
}

std::string emu::ldaq::rui::STEPEventCounter::print() const {
