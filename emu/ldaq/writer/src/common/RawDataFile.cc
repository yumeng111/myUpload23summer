...
void emu::ldaq::writer::RawDataFile::nameFile(){
...
void emu::ldaq::writer::RawDataFile::open(){
...
void emu::ldaq::writer::RawDataFile::close(){ 
...
void emu::ldaq::writer::RawDataFile::writeMetaFile(){
...
time_t emu::ldaq::writer::RawDataFile::toUnixTime( const std::string YYMMDD_hhmmss_UTC ) const {
...
#include <iostream>
unsigned long int emu::ldaq::writer::RawDataFile::toDecimalTime( const std::string& YYMMDD_hhmmss_UTC ) const {
...
std::string emu::ldaq::writer::RawDataFile::chooseEOSSymLink() const {
...
emu::ldaq::writer::RawDataFile::RawDataFile(const uint64_t maxFileSize, 
...
emu::ldaq::writer::RawDataFile::~RawDataFile(){ delete fs_; }

void emu::ldaq::writer::RawDataFile::startNewRun( const int runNumber, 
...
void emu::ldaq::writer::RawDataFile::writeData( const char* buf, const int nBytes ){ 
  /// Writes data to file.
...
void emu::ldaq::writer::RawDataFile::startNewEvent(){
...
void emu::ldaq::writer::RawDataFile::endRun(){ 
...
void emu::ldaq::writer::RawDataFile::endRun( const string runStopTime ){ 
  /// To be called when the run ends.
  runStopTime_ = runStopTime;
  endRun();
}

int emu::ldaq::writer::RawDataFile::getFileSize(){
