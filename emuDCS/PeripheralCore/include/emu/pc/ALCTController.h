...
class ALCTController : public EmuLogger 
{
 public:
  ...
  void PrintExpectedFastControlId();           // print out Expected values				 
  ...
  inline void slowcontrol_read(int op, int cnt, char *rcv)  { alctcontrol_read(0, op, cnt, rcv);  }
  inline void slowcontrol_write(int op, int cnt, char *rcv) { alctcontrol_write(0, op, cnt, rcv); }
  inline void fastcontrol_read(int op, int cnt, char *rcv)  { alctcontrol_read(1, op, cnt, rcv);  }
  inline void fastcontrol_write(int op, int cnt, char *rcv) { alctcontrol_write(1, op, cnt, rcv); }
...
private:
  ...
  void alctcontrol_read(int chain, int op, int cnt, char *rcv);
  void alctcontrol_write(int chain, int op, int cnt, char *data);
