...
{
   // This FIRMWARE_SIZE is the size given in the Xilinx documentation. 
   // The real bit-stream size needed is smaller than this,
   // and the actual size of firmware generated by Xilinx 
   // is usually bigger than this with padding at the end.
