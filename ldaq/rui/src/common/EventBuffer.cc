...
emu::ldaq::rui::EventBuffer::EventBuffer() :
...
bool
emu::ldaq::rui::EventBuffer::appendData( const size_t dataSize, const char* data ){
...
const char* 
emu::ldaq::rui::EventBuffer::getEvent() const { return buffer_; }

size_t
emu::ldaq::rui::EventBuffer::getEventSize() const { return eventSize_; }

void
emu::ldaq::rui::EventBuffer::empty(){ eventSize_ = 0; }

void
emu::ldaq::rui::EventBuffer::grow( const size_t newBufferSize ){
...
ostream& emu::ldaq::rui::operator<<( ostream& os, const emu::ldaq::rui::EventBuffer& eb ){
