...
protected:
  ...
  const xdaq::ApplicationDescriptor          *appDescriptor_; ///< parent application descriptor
  xdaq::ApplicationContext                   *appContext_; ///< parent application context
  const xdaq::Zone                           *zone_; ///< parent application zone

  string                                      clientName_; ///< name of client of this server
  unsigned int                                clientInstance_; ///< instance of client of this server
  const xdaq::ApplicationDescriptor          *clientDescriptor_; ///< application descriptor of client of this server
...
public:
  ...
  ///
  const xdaq::ApplicationDescriptor* getClientDescriptor(){ return clientDescriptor_; }
