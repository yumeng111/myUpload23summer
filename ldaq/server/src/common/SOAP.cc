...
emu::ldaq::server::SOAP::SOAP( xdaq::Application                    *parentApp,
...
emu::ldaq::server::SOAP::~SOAP(){}

void emu::ldaq::server::SOAP::createMIMEInfo(){
...
void emu::ldaq::server::SOAP::addData( const int               runNumber, 
  ...
  LOG4CPLUS_DEBUG(logger_, name_ << " has " << messages_.size() <<
		  ...
		  " credits. Prescaling: 1/" << *prescaling_ << " (emu::ldaq::server::SOAP::addData)");
...
void emu::ldaq::server::SOAP::appendData( char* const             data, 
					 const size_t            dataLength, 
					 const PositionInEvent_t position )
  throw( xoap::exception::Exception )
{
  ...
  LOG4CPLUS_DEBUG(logger_, name_ << " has " << messages_.size() <<
		  ...
		  " credits. Prescaling: 1/" << *prescaling_ << " (emu::ldaq::server::SOAP::appendData)");
...
void emu::ldaq::server::SOAP::makeLastBlockEndEvent(){
...
void emu::ldaq::server::SOAP::createMessage()
  throw ( xoap::exception::Exception )
{
  try{
...
void emu::ldaq::server::SOAP::fillMessage( char* const  data,
					  const size_t dataLength )
  throw( xoap::exception::Exception )
{
  try{
...
xoap::MessageReference emu::ldaq::server::SOAP::getOldestMessagePendingTransmission(){
...
void emu::ldaq::server::SOAP::sendData()
  throw ( xcept::Exception )
{
  ...
  LOG4CPLUS_DEBUG(logger_, name_ << " has " << messages_.size() <<
		  " messages, holding " << *nEventCreditsHeld_ <<
		  " credits. Prescaling: 1/" << *prescaling_ << " (emu::ldaq::server::SOAP::sendData)");
...
void emu::ldaq::server::SOAP::printMessages(){
