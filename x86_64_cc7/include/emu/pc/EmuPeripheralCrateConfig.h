...
private:
  ...
  void DCFEBCounters(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception);
  ...
  void TMBReadUserProms(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception); 
  ...
  void ALCTReadSlowFirmware(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception); 
  void ALCTFastControlRead(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception); 
  void ALCTSlowControlRead(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception); 
  //
  // VCC utils
  ...
  void ODMBDelayScanRing(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception);
  //
